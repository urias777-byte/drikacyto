          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            animationDelay: '0.1s'
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-glow-violet border-4 border-violet/30 aspect-[9/16] max-w-sm mx-auto">
                <video ref={videoRef} src={heroVideo} className="w-full h-full object-cover" loop playsInline onClick={handlePlayClick} onPlay={() => setIsPlaying(true)} onPause={() => setIsPlaying(false)} />
                {!isPlaying && <div className="absolute inset-0 flex items-center justify-center bg-black/30 cursor-pointer transition-opacity hover:bg-black/20" onClick={handlePlayClick}>
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left">
              ...
              {/* Main heading */}
              <h1 className="font-serif text-4xl md:text-5xl font-bold mb-6 animate-fade-in text-violet-300 lg:text-5xl" style={{
              animationDelay: '0.1s'
            }}>
                Você não está{' '}
              ...
              {/* Subheading */}
              <p className="text-lg md:text-xl mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in text-violet-300" style={{
              animationDelay: '0.2s'
            }}>
              ...
              animationDelay: '0.3s'
                ...
                <a href="#solucao" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-violet to-violet-glow text-white rounded-full font-semibold text-lg hover:shadow-glow-violet transition-all duration-300 hover:scale-105">
                  Conhecer Solução
                </a>
                <a href="#faq" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-card border-2 border-violet/30 text-violet rounded-full font-semibold text-lg hover:bg-secondary transition-all duration-300">
                  Tire suas Dúvidas
                </a>
              </div>

              {/* Trust indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in" style={{
              animationDelay: '0.4s'
            }}>
