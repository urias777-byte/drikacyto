...
const TrustSection = () => {
  ...
  return <section id="seguranca" className="relative py-24">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-bold mb-6 text-violet-300">
            Confiança em cada{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {trustItems.map((item, index) => <div key={index} className="group p-6 bg-card/80 backdrop-blur-sm rounded-2xl shadow-soft border border-violet/20 hover:border-violet/50 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="mt-16 p-8 md:p-12 bg-gradient-to-r from-violet to-violet-glow rounded-3xl text-white text-center">
          ...
          <a href="#contato" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-violet rounded-full font-semibold text-lg hover:bg-white/90 transition-all duration-300 hover:scale-105">
