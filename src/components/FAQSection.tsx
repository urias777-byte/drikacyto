  ...
  return <section id="faq" className="relative py-24">
      <div className="container mx-auto px-4">
        ...
        <div id="contato" className="mt-16 text-center">
          ...
          <a href="https://wa.me/553498332213?text=Olá estou querendo adquirir seus produtos." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-violet to-violet-glow text-white rounded-full font-semibold text-lg hover:shadow-glow-violet transition-all duration-300 hover:scale-105">
            Falar pelo WhatsApp
          </a>
        </div>
      </div>
