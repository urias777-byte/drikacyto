...
const FAQSection = () => {
  ...
  return <section id="faq" className="relative py-24">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-bold mb-6 text-violet-500">
            Perguntas{' '}
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-card/80 backdrop-blur-sm rounded-2xl border-2 border-violet/50 px-6 shadow-soft hover:border-violet transition-colors">
        ...
        <div id="contato" className="mt-16 text-center">
          ...
          <a href="https://wa.me/5511953764223?text=Olá estou querendo adquirir seus produtos." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-violet to-violet-glow text-white rounded-full font-semibold text-lg hover:shadow-glow-violet transition-all duration-300 hover:scale-105">
            Falar pelo WhatsApp
          </a>
        </div>
      </div>
